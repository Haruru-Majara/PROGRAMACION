...
public class Ejercicio11b {
	...
	public static void main(String[] args) {
		...
		/**
		 * dado dos archivos de texto. Debemos alinear los bytes, para construir el
		 * archivo original
		 */
		...
		try {
			...
			// el bucle se detendra cuando ambos archivos no tengan ningun byte pendiente de
			// leer
