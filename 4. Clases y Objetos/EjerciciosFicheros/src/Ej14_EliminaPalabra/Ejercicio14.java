	...
	public static void main(String[] args) {
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				/*
				 * * EL TRUCO DE LA LIMPIEZA: (?i) -> No importa si es mayúscula o minúscula.
				 * \\b -> Asegura que borre la palabra entera (que no borre "sol" dentro de
				 * "soldado").
				 */
				String lineaLimpia = line.replaceAll("(?i)\\b" + palabra + "\\b", "");

				// Quitamos espacios dobles que hayan quedado y espacios sobrantes al
				// inicio/final
				...
				// ¡IMPORTANTE! readLine() quita los saltos de línea, así que hay que ponerlos
				// de nuevo
				writer.newLine();
			}
