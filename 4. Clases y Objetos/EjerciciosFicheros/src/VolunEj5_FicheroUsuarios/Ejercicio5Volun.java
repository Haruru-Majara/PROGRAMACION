package VolunEj5_FicheroUsuarios;
...
public class Ejercicio5Volun {
	...
	public static void main(String[] args) {
		...
		try (BufferedWriter writer = Files.newBufferedWriter(archivo, charset, StandardOpenOption.CREATE,
