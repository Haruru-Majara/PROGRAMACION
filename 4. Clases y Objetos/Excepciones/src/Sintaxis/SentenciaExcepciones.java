...
public class SentenciaExcepciones {
	...
	public static void main(String[] args) {
		...
		/*
		 * ¿Qué es una excepción? - Es un error que ocurre en tiempo de ejecución. -
		 * Rompe el flujo normal del programa. - Se pueden controlar con try-catch.
		 */
		...
		/*
		 * - Usa excepciones específicas. - No uses Exception para todo. - Maneja
		 * errores solo si sabes qué hacer. - Usa finally o try-with-resources para
		 * cerrar recursos.
		 */
...
/*
 * MÁS IMPORTANTES PARA EXAMEN: - NullPointerException -
