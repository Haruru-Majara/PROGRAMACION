...
public class Ejemplo_HashSet {
	...
	public static void main(String[] args) {
		...
		/*
		 * HashSet<E>: Colección que almacena elementos únicos.
		 *
		 * Concepto: - No permite elementos duplicados. - No mantiene el orden de
		 * inserción. - Internamente usa un HashMap. - Solo guarda objetos. - Clase del
		 * paquete java.util.
		 */
