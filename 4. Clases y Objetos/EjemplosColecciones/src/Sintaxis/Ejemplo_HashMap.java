...
public class Ejemplo_HashMap {
	...
	public static void main(String[] args) {
		...
		/*
		 * HashMap<K,V>: Estructura que almacena datos en pares clave-valor.
		 *
		 * Concepto: - Cada elemento tiene una clave (key) y un valor (value). - Las
		 * claves no se pueden repetir. - Permite acceder muy rápido a un valor usando
		 * su clave. - No mantiene el orden de los elementos. - Clase del paquete
		 * java.util.
		 */
