...
public class Ejemplo_LinkedList {
	...
	public static void main(String[] args) {
		...
		/*
		 * LinkedList<E>: Ventaja: agregar o eliminar elementos en cualquier posición es
		 * rápido. Desventaja: acceder a un elemento por índice es más lento que en
		 * ArrayList.
		 *
		 * Concepto: - Lista dinámica que crece o se achica sola según lo que metas o
		 * saques. - Internamente usa nodos enlazados (cada elemento apunta al siguiente
		 * y al anterior). - Solo guarda objetos. - Clase de java.util.
		 */
